...
### In-Scope (Phase 2)
- Model training (Random Forest, MLP, XGBoost, Hybrid, TabPFN)
- Hyperparameter tuning execution
- Model evaluation metrics (R², MAE, RMSE)
- Model persistence (save/load joblib)
- Streamlit app prediction workflow
- See `04_modeling_and_deployment/docs/Test_Plan_Phase2.md`
