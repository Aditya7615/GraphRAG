...
### In-Scope (Phase 2)
- ML model training (Random Forest, MLP, XGBoost, Hybrid, TabPFN)
...
| 7 | Model Training & Tuning | ✅ Complete (Phase 2) | `04_modeling_and_deployment/scripts/train_all_models.py` |
| 8 | Model Evaluation | ✅ Complete (Phase 2) | `04_modeling_and_deployment/docs/Model_Training_Report.md` |
| 9 | Streamlit Deployment | ✅ Complete (Phase 2) | `04_modeling_and_deployment/app/app.py` |
...
Train-Test Split (80:20)
        ↓
Model Training (04_modeling_and_deployment/)
  ├── Random Forest (bagging ensemble)
  ├── MLP Neural Network (deep learning)
  ├── XGBoost (gradient boosting)
  ├── Hybrid Stacking (RF + MLP + XGB + Ridge meta)
  └── TabPFN (transfer learning / zero-shot)
        ↓
...
Best Model Selection
        ↓
Streamlit App Deployment (app/app.py)
        ↓
